...
const MODES = {
  signal: { label: 'Signal', hint: 'What do you want to say publicly?' },
  conversation: { label: 'Conversation', hint: 'What do you want to say to one person?' },
  strategy: { label: 'Strategy', hint: 'What are you trying to decide or win?' },
};
